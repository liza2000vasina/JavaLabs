...
public class FileReadersTest {
    ...
    @Test
    public void testReadWholeFileOnEmptyFile() throws FileReaderException {
    ...
    @Test
    public void testReadWholeFileOnFileWithEmptyLines() throws FileReaderException {
    ...
    @Test
    public void testReadWholeFile() throws FileReaderException {
